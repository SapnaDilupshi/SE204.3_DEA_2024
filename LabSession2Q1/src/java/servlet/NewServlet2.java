...
public class NewServlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /**
         * Question 3
         * Create a servlet that sets custom response headers such as "Content-Type" and "Cache-Control" and 
         * sends a simple message as the response body.
         */
        ...
        out.println("Custom response headers are set succesfully");
