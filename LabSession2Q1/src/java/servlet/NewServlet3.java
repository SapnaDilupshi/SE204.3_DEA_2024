...
public class NewServlet3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /**
         * Question 4
         * Develop a servlet that redirects the user to another webpage using the "Location" response header
         * Include a delay by setting the "Refresh" header.
         */
        ...
        response.getWriter().println("<p>You will be redirected to " + redirectUrl + "in " +delayInSeconds + "seconds...</p>");
    }
